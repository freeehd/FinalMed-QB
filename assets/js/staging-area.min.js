const jQuery=window.jQuery;jQuery(document).ready(n=>{const t=n("#wqb-staging-area-root"),i=window.wqb_data;if(t.length===0)return;const a=[{quote:"Success is not final, failure is not fatal: it is the courage to continue that counts.",author:"Winston Churchill"},{quote:"The only way to do great work is to love what you do.",author:"Steve Jobs"},{quote:"Believe you can and you're halfway there.",author:"Theodore Roosevelt"},{quote:"The future belongs to those who believe in the beauty of their dreams.",author:"Eleanor Roosevelt"},{quote:"Don't watch the clock; do what it does. Keep going.",author:"Sam Levenson"},{quote:"The expert in anything was once a beginner.",author:"Helen Hayes"},{quote:"Your time is limited, don't waste it living someone else's life.",author:"Steve Jobs"},{quote:"The only limit to our realization of tomorrow will be our doubts of today.",author:"Franklin D. Roosevelt"}];function c(){return a[Math.floor(Math.random()*a.length)]}function w(o,e={}){if(!o)return"";const s=e.resume||"wqb-resume-session",r=e.newSession||"wqb-start-new-session";return`
      <div class="wqb-active-session-info">
        <div class="wqb-session-status">
          ...
          <span class="wqb-session-mode">${o.mode==="mock"?"Mock Test":"Practice"}</span>
        </div>
        <div class="wqb-session-progress">
          <div class="wqb-progress-info">
            <span class="wqb-progress-text">Progress: ${o.answered_count} of ${o.total_questions} questions</span>
            <span class="wqb-progress-percentage">${o.progress_percentage}%</span>
          </div>
          <div class="wqb-progress-bar">
            <div class="wqb-progress-fill" style="width: ${o.progress_percentage}%"></div>
          </div>
        </div>
        <div class="wqb-session-details">
          <span class="wqb-session-time">Started: ${new Date(o.created_at).toLocaleDateString()}</span>
          <span class="wqb-session-expires">Expires: ${new Date(o.expires_at).toLocaleDateString()}</span>
        </div>
    ...
    `}function u(o){const e=o.performance_stats,s=o.heatmap_data,r=o.username,l=o.active_session,d=c();let v=`
            <div class="wqb-staging-area">
                ...
                <div class="wqb-staging-header">
                    <h1>Hi ${r}, welcome to the Finalmed Question Bank!</h1>
                            ...
                            <div class="wqb-card-content">
                                <div class="wqb-quick-stats">
                                    <div class="wqb-quick-stat">
                                        <span class="wqb-quick-stat-value">${e.overall_percentage}%</span>
                                        <span class="wqb-quick-stat-label">Accuracy</span>
                                    </div>
                                    <div class="wqb-quick-stat">
                                        <span class="wqb-quick-stat-value">${e.overall_total}</span>
                                        <span class="wqb-quick-stat-label">Questions</span>
                                    </div>
                                    <div class="wqb-quick-stat">
                                        <span class="wqb-quick-stat-value">${e.overall_correct}</span>
   ...
   <div class="wqb-staging-heatmap-section">
            ...
            </div>`;t.html(v),h(s)}function h(o){window.WQBHeatmapUtils&&window.WQBHeatmapUtils.initializeStandaloneHeatmap?window.WQBHeatmapUtils.initializeStandaloneHeatmap(o).then(()=>{window.WQBHeatmapUtils&&window.WQBHeatmapUtils.reinitializeHeatmapOnResize&&window.WQBHeatmapUtils.reinitializeHeatmapOnResize("#wqb-standalone-cal-heatmap",o,{})}).catch(e=>{console.error("Failed to initialize staging area heatmap:",e)}):console.error("WQBHeatmapUtils not available")}t.html(`
        <div class="wqb-staging-loading">
            <div class="wqb-loading-spinner"></div>
            <p>Loading your staging area...</p>
        </div>
    `),n.ajax({url:i.ajax_url,type:"POST",data:{action:"wqb_get_staging_data",nonce:i.nonce},dataType:"json",success:o=>{var e;o.success?u(o.data):t.html(`
                    <div class="wqb-staging-error">
                        ...
                        <p>Error: ${((e=o.data)==null?void 0:e.message)||"Unknown error"}</p>
                    </div>
                `)},error:(o,e,s)=>{console.error("AJAX Error:",{xhr:o,status:e,error:s}),t.html(`
                <div class="wqb-staging-error">
                    <div class="wqb-error-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
